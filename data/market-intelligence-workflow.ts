...
const supervisorNode: LineageNode = {
    ...
    data: {
        ...
        aiExplanation:
            "The Supervisor breaks down complex requests into smaller tasks and assigns them to experts (Ingestion, Enrichment, Analyst). It interacts with the Data Ingestion Agent to fetch raw data, the Enrichment Agent to add context, the Intelligence Analyst to find patterns, and the Synthesis Agent to create the final report. This oversight ensures a complete and structured response to the user's query.",
        interactions: [
            {
...
const ingestionAgent: LineageNode = {
    ...
    data: {
        ...
        aiExplanation:
            "The Data Collector searches the web, news feeds, and market APIs to find raw information. It specifically interacts with the Market Data API to check volatility and the News Feed MCP to gather recent headlines, filtering out noise to retain only the relevant facts.",
        interactions: [
            {
...
const enrichmentAgent: LineageNode = {
    ...
    data: {
        ...
        aiExplanation:
            "The Context Encoder interprets raw text and data to add semantic meaning. It calculates high-dimensional vectors and interacts with the Vector Store to retrieve historical risk profiles and contextualize new information. This process links specific news items to broader topics like 'Supply Chain' or 'Geopolitics' to provide a comprehensive picture.",
        interactions: [
            {
...
const analysisAgent: LineageNode = {
    ...
    data: {
        ...
        aiExplanation:
            "The Intelligence Analyst identifies hidden patterns and connections within the data. It utilizes GPT-4 Turbo to validate correlations between facility locations and regional instability, determining whether a piece of news constitutes a significant signal that impacts business operations or is merely noise.",
        interactions: [
            {
...
const riskAgent: LineageNode = {
    ...
    data: {
        ...
        aiExplanation:
            "The Risk Evaluator calculates a concrete risk score based on the gathered evidence. It consults Claude 3 Opus to weigh various factors such as geopolitical tension, supply chain vulnerabilities, and regulatory changes, providing a clear 'High', 'Medium', or 'Low' risk rating.",
        interactions: [
            {
...
const synthesisAgent: LineageNode = {
    ...
    data: {
        ...
        aiExplanation:
            "The Report Writer synthesizes all findings into a final executive brief. It interacts with the Analytics Database to persist the report for audit purposes, ensuring that key findings and actionable recommendations are presented clearly and concisely.",
        interactions: [
            {
